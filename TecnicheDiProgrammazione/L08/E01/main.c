...
void trova_altezze(int nr, int nc, int tabella[MAXR][MAXR],struct_vettore vettore[nr*nc])
{
    int i,j,a=-1,b,flag;
    int dim=nr*nc;
...
void trova_lunghezze(int nr, int nc, int tabella[MAXR][MAXR],struct_vettore vettore[nr*nc])
{
    int i,j,t;
    for(t=0;t<nr*nc;t++)
    {
